...
#### Cleaning variables
We have in total 160 variables, but not all the variables are relevent in our prediction. Therefore, we conduct the data cleaning.
...
#### Train model
We conduct the Train model with random forest. Cross validation is used as train control method.
